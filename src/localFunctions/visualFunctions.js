...
import { darkGray, lightGray, rejectRed, almostWhite, flagRed, highlightGreen, mantisGreen, treeGreen, bgGray, lightPurple } from '../colors';
...
const GrayLine = () => (
    <View style={{backgroundColor: bgGray, height: 3}}/>
)
...
const MarketplaceIcon = ({strokeWidth, focused}) => (
    <View style={{width: 25, height: 30, alignItems: 'center'}}>
      <Svg height={"100%"} width={"100%"} fill={!focused ? "black" : lightPurple} viewBox={!focused ? "0 0 420 420" : "0 0 400 360"}>
          ...
          stroke={!focused ? "black" : lightPurple}
