...
import {lightGray, treeGreen, highlightGreen, lightGreen, logoGreen, mantisGreen, almostWhite, lightPurple, darkPurple} from '../colors'
...
//now that person has input text, their email and password are here
    ...
    render() {
        ...
        return (
            <SafeAreaView style={[{flex: 1, backgroundColor: darkPurple}]}>
